...
public class FormValidator {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < codeLength; i++) {
			...
			String fileName = "D:\\poly\\INF2010\\TP1\\src\\alphabet\\" + letter + ".ppm";
		...
		PixelMapPlus codedImage = new PixelMapPlus(PixelMap.ImageType.Color, pm[0].height, codeLength * pm[0].width);
	 ...
	 * aleatoires choisis entre A et Z
	 * 
	 * @param length
	 *            : longueur de la chaine de caractere a generer (inferieur ou
	 *            egal a 10)
	 */
	private static String generateCode(int length) {
		...
		for (int i = 0; i < length; i++) {
			int a = Math.abs(generator.nextInt()) % 26;
			char b = (char) ((int) 'A' + a);
			charKey[i] = b;
		}
