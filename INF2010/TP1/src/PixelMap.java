...
public class PixelMap {
	...
	public void clearData() {
		// compléter
		// Le Garbage Collector vide la mémoire tout seul
		// car les AbstractPixel ne sont plus référencés
	 ...
	 * @throws IOException
	 *             : renvoie une erreur le cas echeant (disque plein par ex.)
	 */
	 ...
	 * @throws IOException
	 *             : renvoie une erreur le cas echeant (pas de ficher par ex.)
	 */
