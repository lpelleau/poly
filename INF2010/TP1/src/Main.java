...
public class Main {
	...
	public static void main(String[] args) {
		...
		PixelMap pmc = new PixelMap("D:\\poly\\INF2010\\TP1\\src\\ed.ppm");
		...
		PixelMapPlus pmp = new PixelMapPlus("D:\\poly\\INF2010\\TP1\\src\\ed.ppm");
		pmp.rotate(pmp.height / 2, pmp.width / 2, 1.334);
